...
<html lang="en">
  <head>
    ...
    <title>Arnold and Paz Organic Farm · signup / login modal</title>
    <link
    ...
    <style>
      ...
      *::after {
      ...
      .modal-container {
        ...
        max-width: 1000px;        /* slightly wider to accommodate */
        width: 100%;
        border-radius: 20px;
      ...
      .modal-form-panel {
        background: #ffffff;
        padding: 2.8rem 2.6rem 2.2rem; /* more breathing room */
        display: flex;
        flex-direction: column;
        position: relative;
      }
      ...
      .form-group {
        margin-bottom: 1.1rem;    /* a bit more spacing */
      }
      .form-group label {
        font-size: 0.75rem;
        font-weight: 700;
      ...
      .form-group input[type="password"] {
        width: 100%;
        padding: 0.85rem 1rem;    /* taller inputs */
      ...
      .btn-modal {
        width: 100%;
        padding: 0.95rem;          /* slightly bigger button */
        background: var(--green-mid);
        border: none;
        border-radius: 10px;
        color: white;
      ...
      .modal-brand-panel {
        ...
        padding: 2.6rem 1.8rem;    /* adjust padding to fit */
        display: flex;
        flex-direction: column;
        align-items: center;
        justify-content: center;
  ...
  <body>
    ...
    <div class="modal-overlay" id="authModal">
      <div class="modal-container">
        ...
        <div class="modal-form-panel">
          ...
          <!-- LOGIN FORM -->
          <form class="auth-form active-form" id="loginForm">
            <div class="form-group">
              <label>Email Address</label>
              <input
                type="email"
                placeholder="hello@organicfarm.com"
                required
              />
            </div>
            <div class="form-group">
            ...
            <div class="form-row-space">
              <span class="forgot-link">Forget Password?</span>
            </div>
            ...
            <div class="form-footer">
              ...
              <span class="link-action" id="gotoSignupFromLogin">Sign up</span>
            </div>
          </form>
          ...
          <form class="auth-form" id="signupForm">
            <div class="form-group">
              <label>Name</label>
              <input type="text" placeholder="Arnold Paz" required />
            </div>
            <div class="form-group">
              <label>Email Address</label>
              <input
        ...
        <!-- RIGHT: Branding Panel (slightly narrower) -->
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        ...
        <div class="hero-cta">
          <a href="#products" class="btn-primary">Get Started</a>
    ...
    <footer>
      ...
      <div class="footer-bottom">
        <span>© 2026 Arnold and Paz Organic Farm. All rights reserved.</span
    ...
    <script>
      (function () {
        ...
        const gotoSignup = document.getElementById("gotoSignupFromLogin");
        const gotoLogin = document.getElementById("gotoLoginFromSignup");
        ...
        function showTab(tab) {
          ...
          modalTitle.textContent = isLogin ? "Welcome" : "Create Account";
          modalSubtitle.textContent = isLogin
            ? "to Producer of Vermicast-Organic Fertilizer"
            : "Join the Arnold & Paz farm community";
        }
        ...
        gotoSignup.addEventListener("click", () => showTab("signup"));
        gotoLogin.addEventListener("click", () => showTab("login"));
